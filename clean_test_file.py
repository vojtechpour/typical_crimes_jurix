...
# Load the test data
with open('data/kradeze_pripady_test_100_2_balanced_dedupl.json', 'r', encoding='utf8') as f:
    data = json.load(f)
...
with open('data/kradeze_pripady_test_100_2_balanced_dedupl.json', 'w', encoding='utf8') as f:
    json.dump(data, f, indent=2, ensure_ascii=False)

print('✅ All initial_code_0 fields have been deleted from the test file')
print(f'Total cases in test dataset: {len(data)}') 